        ...
        <div class="box-content mx-auto max-w-7xl py-10">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <address class="flex flex-col mb-[1rem] not-italic font-normal">
                        <a v-if="options.phone" :href="'tel:' + options.phone"
                           class="mb-[5px] text-white text-center no-underline">
                            {{ options.phone }}
                        </a>
                        <a v-if="options.email" :href="'mailto:' + options.email"
                           class="email text-white text-center no-underline">
                            {{ options.email }}
                        </a>
                    </address>
                    ...
                    <div v-if="options.schedule">
                        ...
                        <div class="text-white flex flex-col uppercase" v-html="options.schedule"></div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 text-center">
                ...
                <a v-if="pages.length"
                   ...
                   class="no-underline text-white mb-3"
                >
                    {{ page.heading[lang] }}
                </a>
            </div>
