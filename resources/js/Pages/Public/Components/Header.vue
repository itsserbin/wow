<template>
    ...
    <div class="shadow-lg ">
                    ...
                    <div class=" max-w-[55px]">
                        <div class="relative whitespace-nowrap left-[0.4rem]">
                            ...
                            <button @click="setLangActiveClass"
                                ...
                                type="button">UA<svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none"
                            ...
                            <div class="hidden absolute z-4 top-[35px] left-[-5px] p-[10px] bg-[#fff] "
                                :class="{'active': state.langActiveClass}">
        ...
        <div class=" bg-[#ffb7b7]">
            <div class="container">
                <div class="row">
                    <HeaderCategories :categoriesList="state.categoriesList" :categoryRoute="categoryRoute"
                        :lang="lang" />
                </div>
            </div>
        </div>
        <transition name="fadeLast">
            <div class="burger-menu     active flex flex-row justify-center fixed w-[100%] h-[100%] z-40 top-[0] left-0 overflow-scroll bg-[#161616] "
                v-if="state.showBurger">
                ...
                <div class="menus  justify-center items-center flex mt-[30px]">
                    ...
                    <nav class="menu">
                        <ul class="menu__list flex flex-col justify-center items-center mr-[20px]">
                            <li>
                                <a :href="indexRoute"
                                    class="line relative inline-block font-bold text-[15px] text-center text-[#fff] no-underline after:content-[''] after:bg-[#c4c4c4] after:bottom-0 after:h-[1px] after:left-0 after:mx-auto after:my-auto after:absolute after:right-0 after:w-0">
                                    {{ lang === 'ru' ? 'Главная' : 'Головна' }}
                                </a>
                            </li>
                            <li>
                                <a :href="reviewsRoute"
                                    class=" relative inline-block font-bold text-[15px] text-center text-[#fff] no-underline after:content-[''] after:bg-[#c4c4c4] after:bottom-0 after:h-[1px] after:left-0 after:mx-auto after:my-auto after:absolute after:right-0 after:w-0">
                                    {{ textReviews }}
                                </a>
                            </li>
        ...
        <div class="flex flex-col items-center">
            <div class="row">
                <address class="address text-center">
                    ...
                    <a v-if="appPhone" :href="'tel:' + appPhone" class="phonecall text-decoration-none">
                        {{ appPhone }}
                    </a>

                    <a v-if="appEmail" :href="'mailto:' + appEmail" class="email text-decoration-none">
                        {{ appEmail }}
                    </a>
