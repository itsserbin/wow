                        ...
                        <div class="bg-[#fff] border-[0.5px] rounded-[15px] shadow-lg box-border mb-[1.5rem] pt-[1.5rem] pr-[1rem] pb-[1.25rem] pl-[1rem]">
                            ...
                            <div class="data-list">
                                <div class="mb-[1rem]"><label class="text-[1.075rem] text-[#686868] font-[500] w-[100%] inline-block">Ім`я <input type="text"
                                            placeholder="Введіть ваше ім'я" class="text-[1rem] border-[0.5px] border-red-400    rounded-[10px] box-border mt-[0.75rem] p-[1rem] w-[100%] ">
                                        <!---->
                                    </label></div>
                                <div class="mb-[1rem]"><label class="text-[1.075rem] text-[#686868] font-[500] w-[100%] inline-block">Прізвище <input type="text"
                                            placeholder="Введіть прізвище" class="text-[1rem] border-[0.5px] border-red-400   rounded-[10px] box-border mt-[0.75rem] p-[1rem] w-[100%]">
                                        <!---->
                                    </label></div>
                                <div class="mb-[1rem]"><label class="text-[1.075rem] text-[#686868] font-[500] w-[100%] inline-block">По батькові <input type="text"
                                            placeholder="Введіть по батькові" class="text-[1rem] border-[0.5px] border-red-400  focus:border-red-600 active:border-red-600 rounded-[10px] box-border mt-[0.75rem] p-[1rem] w-[100%]">
                                        <!---->
                                    </label></div>
                                <div class="mb-[1rem]"><label class="text-[1.075rem] text-[#686868] font-[500] w-[100%] inline-block">Номер телефону <span
                                            ...
                                            data-mask-raw-value="" class="text-[1rem] border-[0.5px] border-red-400   rounded-[10px] box-border mt-[0.75rem] p-[1rem] w-[100%]">
                                        <!---->
                                    </label></div>
                                <div class="mb-[1rem]"><label class="text-[1.075rem] text-[#686868] font-[500] w-[100%] inline-block">Email <input type="email"
                                            placeholder="Введіть вашу пошту" class="text-[1rem] border-[0.5px] border-red-400   rounded-[10px] box-border mt-[0.75rem] p-[1rem] w-[100%]">
                                        <!---->
                                    </label></div>
                            </div>
                        </div>
