...
class AdminController extends Controller
{
    ...
    {
        return Inertia::render('Statistics/BankCardMovements/Index');
    }


    final public function statisticProfitAndLoss(): Response
    {
        return Inertia::render('Statistics/ProfitAndLoss/Index');
    }

    final public function statisticCashFlow(): Response
    {
        return Inertia::render('Statistics/CashFlow/Index');
    }

    final public function statisticCostProfitCategories(): Response
    {
        return Inertia::render('Statistics/CostProfitCategories/Index');
    }
