import{r as d,g as l,i as t,l as r,s as c,v as i,j as h,F as p,D as u,p as a}from"./app-85fc3642.js";const _={class:"mb-3"},m={class:"ml-auto"},b={class:"rounded-[10px] border-red-600 border-[3px] flex justify-center max-w-[230px] relative m-0 p-2"},f=t("span",{class:"before:content-['\\f0ce'] col-span-1"},null,-1),v={class:"col-span-3"},x=["innerHTML"],S={__name:"SizesTable",props:{sizeTable:{type:String,default:`<table>
                <tr>
                    <th>Размеры</th>
                    <th>Чашка</th>
                    <th>Объем груди</th>
