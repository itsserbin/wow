...
import _sfc_main$3 from "./Chart-0e68e821.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const fetch = async () => {
      ...
      await axios.get(route("api.statistics.costs.chart", getParams.value)).then(({ data }) => state.value.costs = data.result).catch((errors) => console.log(errors));
      await axios.get(route("api.statistics.profits.chart", getParams.value)).then(({ data }) => state.value.profits = data.result).catch((response) => console.log(response));
      await axios.get(route("api.statistics.orders.chart", getParams.value)).then(({ data }) => state.value.orders = data.result).catch((response) => console.log(response));
      await axios.get(route("api.statistics.marketing.chart", getParams.value)).then(({ data }) => state.value.marketing = data.result).catch((response) => console.log(response));
    };
              ...
              createVNode("div", { class: "grid grid-cols-1 gap-4" }, [
                ...
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                  ...
                  unref(can)("show-bookkeeping-profits") ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("hr", { class: "my-1" }),
                    state.value.profits ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      chartData: state.value.profits
                    }, null, 8, ["chartData"])) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true)
                ...
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                  unref(can)("show-bookkeeping-orders") ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("hr", { class: "my-1" }),
                    state.value.orders ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      chartData: state.value.orders
                    }, null, 8, ["chartData"])) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true),
                  unref(can)("show-bookkeeping-marketing") ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("hr", { class: "my-1" }),
                    state.value.marketing ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      chartData: state.value.marketing
                    }, null, 8, ["chartData"])) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true)
