import { ref, computed, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, withDirectives, vModelCheckbox, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrInterpolate, ssrRenderStyle, ssrRenderComponent } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid grid-cols-1 gap-4"><div class="block"><label class="block mb-2 text-sm font-medium text-gray-900"> Розміри </label><ul class="grid w-full gap-2 grid-cols-5"><!--[-->`);
