...
import "./ProductCards-1bca5486.mjs";
...
const ProductsRepository = {
  ...
  async updateSort(id, sort) {
    try {
      const response = await axios.post(route("api.products.sort.update", id), { sort });
      return response.data;
    } catch (e) {
      return console.log(e);
    }
