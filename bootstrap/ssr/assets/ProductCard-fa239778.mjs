  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.product.preview) {
        ...
        _push(`<img${ssrRenderAttr("src", _ctx.route("images.350", __props.product.preview.src))}${ssrRenderAttr("alt", __props.product.h1[__props.lang])} class="object-cover w-full rounded-t-lg h-56 md:h-72"></picture>`);
      } else {
        _push(`<!---->`);
      }
