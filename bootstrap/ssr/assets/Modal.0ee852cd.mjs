...
import _sfc_main$1 from "./Form.cefacdb2.mjs";
const _sfc_main = {
  __name: "Modal",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Options/Advantages/Modal.vue");
