...
import _sfc_main$1 from "./Form-50982968.mjs";
const _sfc_main = {
  __name: "Modal",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Content/Reviews/Socials/Modal.vue");
