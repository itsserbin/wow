            ...
            ssrRenderList(__props.categories, (category) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(Link), { class: "text-center py-2" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<a${ssrRenderAttr("href", _ctx.route("category", category.slug))} class="font-bold text-sm whitespace-nowrap"${_scopeId3}>${ssrInterpolate(unref(title)(category.title))}</a>`);
                        } else {
                          return [
                            createVNode("a", {
                    ...
                    return [
                      createVNode(unref(Link), { class: "text-center py-2" }, {
                        default: withCtx(() => [
                          createVNode("a", {
                            href: _ctx.route("category", category.slug),
                            class: "font-bold text-sm whitespace-nowrap"
