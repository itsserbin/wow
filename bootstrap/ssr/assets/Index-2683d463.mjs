...
import _sfc_main$1 from "./Modal-3d95ac1a.mjs";
import _sfc_main$2 from "./OptionsLayout-6faa4c69.mjs";
import _sfc_main$4 from "./Table-5a6f8ac8.mjs";
          ...
          if (_push2) {
            ...
            return [
              ...
              !state.value.isLoading && unref(can)("show-xml") ? (openBlock(), createBlock("div", { key: 1 }, [
                unref(can)("create-xml") ? (openBlock(), createBlock(_sfc_main$3, {
                  key: 0,
                  type: "btn",
                  onClick: create
                }, {
