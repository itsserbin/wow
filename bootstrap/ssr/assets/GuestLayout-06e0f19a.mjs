...
import { _ as _sfc_main$1 } from "./ApplicationLogo-fe90ffe2.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), { href: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$1, { class: "w-20 h-20 fill-current text-gray-500" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$1, { class: "w-20 h-20 fill-current text-gray-500" })
            ];
          }
        }),
        _: 1
