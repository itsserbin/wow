          ...
          if (_push2) {
            ...
            return [
              data.row.product ? (openBlock(), createBlock("picture", { key: 0 }, [
                ...
                createVNode("img", {
                  src: data.row.product.preview ? _ctx.route("images.350", data.row.product.preview.src) : null,
