...
import _sfc_main$2 from "./CartIcon.79888d2e.mjs";
import _sfc_main$3 from "./Langs.3ba4b35e.mjs";
import _sfc_main$1 from "./Logo.5e8f1180.mjs";
import _sfc_main$4 from "./HeaderCategories.0e67c59a.mjs";
import "vuex";
import "swiper";
import "swiper/vue";
const _sfc_main = {
  ...
  setup(__props) {
    const Burger = defineAsyncComponent(() => import("./Burger.5bdefb2a.mjs"));
    ref(false);
    ref(false);
    ref({
      showBurger: false,
