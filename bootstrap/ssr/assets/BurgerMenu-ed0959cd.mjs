...
const _sfc_main = {
  ...
  props: ["options", "lang"],
  setup(__props) {
    const ViberIcon = defineAsyncComponent(() => import("./ViberIcon-88f39f95.mjs"));
    const TelegramIcon = defineAsyncComponent(() => import("./TelegramIcon-7c8f154e.mjs"));
    const InstagramIcon = defineAsyncComponent(() => import("./InstagramIcon-ed94da8f.mjs"));
    const FacebookIcon = defineAsyncComponent(() => import("./FacebookIcon-81925f00.mjs"));
