...
import { _ as _sfc_main$1 } from "./MasterLayout-c33997a7.mjs";
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    const props = __props;
    const MainBanners = defineAsyncComponent(() => import("./Banners-3195e1e8.mjs"));
    const Categories = defineAsyncComponent(() => import("./Categories-b79e1f19.mjs"));
    const ProductsList = defineAsyncComponent(() => import("./ProductsList-cf30f37e.mjs"));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.banners.length) {
        _push(ssrRenderComponent(unref(MainBanners), {
      ...
      if (__props.categories.length) {
        _push(ssrRenderComponent(unref(Categories), {
      ...
      _push(ssrRenderComponent(unref(ProductsList), {
        slider: true,
        lang: __props.lang,
