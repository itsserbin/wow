    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        refunds: withCtx(({ data }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$filters.yesOrNo(data.row.refunds))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$filters.yesOrNo(data.row.refunds)), 1)
            ];
          }
        }),
        prepayment: withCtx(({ data }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$filters.yesOrNo(data.row.prepayment))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$filters.yesOrNo(data.row.prepayment)), 1)
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Options/Providers/Table.vue");
