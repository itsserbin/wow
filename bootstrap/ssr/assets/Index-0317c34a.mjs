...
import _sfc_main$1 from "./Modal-e4fda682.mjs";
import _sfc_main$2 from "./OptionsLayout-49f01291.mjs";
import _sfc_main$3 from "./Table-9b2363c8.mjs";
import "./Form-c69040c4.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ title: "Кольори" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Кольори `);
          } else {
            return [
              createTextVNode(" Кольори ")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!state.value.isLoading && unref(can)("show-sizes")) {
              _push2(`<div${_scopeId}>`);
            ...
            return [
              ...
              !state.value.isLoading && unref(can)("show-sizes") ? (openBlock(), createBlock("div", { key: 1 }, [
