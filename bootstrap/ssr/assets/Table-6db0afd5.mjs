    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        image: withCtx(({ data }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", data.row.image_mobile.ua ? _ctx.route("images.banners.mobile", data.row.image_mobile.ua) : data.row.image_mobile.ru ? _ctx.route("images.banners.mobile", data.row.image_mobile.ru) : null)}${ssrRenderAttr("alt", data.row.title[activeLang.value])} class="w-1/4 mx-auto"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
        ...
        link: withCtx(({ data }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(data.row.link[activeLang.value])}`);
          } else {
            return [
              createTextVNode(toDisplayString(data.row.link[activeLang.value]), 1)
            ];
          }
        }),
